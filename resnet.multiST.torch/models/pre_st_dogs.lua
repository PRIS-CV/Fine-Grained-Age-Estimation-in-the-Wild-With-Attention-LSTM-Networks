...
local function createModel(opt)
   ...
   local preresnet = torch.load('/home/scw4150/ln/ST/resnet.multiST.torch/resnet-34.t7')
   ...
   local spatial1 = networks.new_spatial_transformer('64,300,64', nil,nil,nil, 28, 128, false)--stn1
   spatial_params = spatial1:getParameters()
   model_new:add(spatial1)
   print(spatial_params:size())
   model_new:add(preresnet:get(7))
   local spatial2 = networks.new_spatial_transformer('64,300,64', nil,nil,nil, 14, 256, false)--stn2
...
print(model_new)
   ...
   local fclast = nn.Linear(512,120)
   fclast.weight:zero()
   --fclast.bias =
